// D import file generated from 'org\eclipse\swt\internal\ole\win32\extras.d'
...
enum : int
{
	...
	S_FALSE = 1,
	NOERROR = 0,
	E_NOTIMPL = cast(int)2147500033u,
	E_NOINTERFACE = cast(int)2147500034u,
	E_POINTER = cast(int)2147500035u,
	E_ABORT = cast(int)2147500036u,
	E_FAIL = cast(int)2147500037u,
	E_HANDLE = cast(int)2147942406u,
	CLASS_E_NOAGGREGATION = cast(int)2147746064u,
	E_OUTOFMEMORY = cast(int)2147942414u,
	E_INVALIDARG = cast(int)2147942487u,
	E_UNEXPECTED = cast(int)2147549183u,
}
enum 
{
