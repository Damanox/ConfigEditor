// D import file generated from 'org\eclipse\swt\internal\win32\WINTYPES.d'
...
else
{
	...
	const int RASCS_DONE = 8192;

	const int RASCS_PAUSED = 4096;
	...
	extern (Windows) alias HDDEDATA function(UINT, UINT, HCONV, HSZ, HSZ, HDDEDATA, DWORD, DWORD) PFNCALLBACK;
	...
	enum : DWORD
	{
		...
		CDERR_STRUCTSIZE = 1,
		PDERR_CREATEICFAILURE = 4096 + 10,
		PDERR_DEFAULTDIFFERENT = 4096 + 12,
		PDERR_DNDMMISMATCH = 4096 + 9,
		PDERR_GETDEVMODEFAIL = 4096 + 5,
		PDERR_INITFAILURE = 4096 + 6,
		PDERR_LOADDRVFAILURE = 4096 + 4,
		PDERR_NODEFAULTPRN = 4096 + 8,
		PDERR_NODEVICES = 4096 + 7,
		PDERR_PARSEFAILURE = 4096 + 2,
		PDERR_PRINTERNOTFOUND = 4096 + 11,
		PDERR_RETDEFFAILURE = 4096 + 3,
		PDERR_SETUPFAILURE = 4096 + 1,
		CFERR_MAXLESSTHANMIN = 8192 + 2,
		CFERR_NOFONTS = 8192 + 1,
		FNERR_BUFFERTOOSMALL = 12288 + 3,
		FNERR_INVALIDFILENAME = 12288 + 2,
		FNERR_SUBCLASSFAILURE = 12288 + 1,
		FRERR_BUFFERLENGTHZERO = 16384 + 1,
		...
		DBG_EXCEPTION_NOT_HANDLED = 2147549185u,
		...
		EXCEPTION_GUARD_PAGE = 2147483649u,
		...
		LR_DEFAULTCOLOR = 0,
		LR_LOADREALSIZE = 128,
		MAILSLOT_WAIT_FOREVER = 4294967295u,
		MAILSLOT_NO_MESSAGE = 4294967295u,
		CMB_MASKED = 2,
		...
		SERVICE_DELETE = 65536,
		SERVICE_READ_CONTROL = 131072,
		SERVICE_GENERIC_EXECUTE = 536870912,
		...
		EXCEPTION_FLT_DENORMAL_OPERAND = 3221225613u,
		EXCEPTION_FLT_DIVIDE_BY_ZERO = 3221225614u,
		EXCEPTION_FLT_INEXACT_RESULT = 3221225615u,
		EXCEPTION_FLT_INVALID_OPERATION = 3221225616u,
		EXCEPTION_FLT_OVERFLOW = 3221225617u,
		EXCEPTION_FLT_STACK_CHECK = 3221225618u,
		EXCEPTION_FLT_UNDERFLOW = 3221225619u,
		EXCEPTION_INT_DIVIDE_BY_ZERO = 3221225620u,
		EXCEPTION_INT_OVERFLOW = 3221225621u,
		EXCEPTION_INVALID_HANDLE = 3221225480u,
		EXCEPTION_PRIV_INSTRUCTION = 3221225622u,
		EXCEPTION_NONCONTINUABLE_EXCEPTION = 3221225509u,
		EXCEPTION_NONCONTINUABLE = 1,
		EXCEPTION_STACK_OVERFLOW = 3221225725u,
		EXCEPTION_INVALID_DISPOSITION = 3221225510u,
		FILE_TYPE_UNKNOWN = 0,
		FILE_TYPE_DISK = 1,
		FILE_TYPE_CHAR = 2,
		FILE_TYPE_PIPE = 3,
	...
	enum : DWORD
	{
		...
		ILD_NORMAL = 0,
		ILD_TRANSPARENT = 1,
		CLR_NONE = 4294967295u,
		CLR_DEFAULT = 4278190080u,
		CLR_INVALID = 4294967295u,
		LR_LOADFROMFILE = 16,
		...
		IME_REGWORD_STYLE_USER_FIRST = 2147483648u,
		...
		LOCALE_NOUSEROVERRIDE = 2147483648u,
		CAL_ICALINTVALUE = 1,
		...
		PARITY_MARK = 2048,
		PARITY_SPACE = 4096,
		COMMPROP_INITIALIZED = 3879531822u,
		CBR_110 = 110,
		CBR_300 = 300,
		CBR_600 = 600,
		CBR_1200 = 1200,
	...
	enum : DWORD
	{
		TVI_ROOT = 4294901760u,
		TVI_FIRST = 4294901761u,
		TVI_LAST = 4294901762u,
		TVI_SORT = 4294901763u,
		TVHT_ABOVE = 256,
		TVHT_BELOW = 512,
		TVHT_NOWHERE = 1,
		TVHT_ONITEM = 70,
	...
	const 
	{
		...
		HWND HWND_BROADCAST = cast(HWND)65535;
	}
	enum : DWORD
	{
		CD_LBSELCHANGE = 0,
		...
		STATUS_TIMEOUT = 258,
		STATUS_PENDING = 259,
		STATUS_GUARD_PAGE_VIOLATION = 2147483649u,
		STATUS_DATATYPE_MISALIGNMENT = 2147483650u,
		STATUS_BREAKPOINT = 2147483651u,
		STATUS_SINGLE_STEP = 2147483652u,
		STATUS_IN_PAGE_ERROR = 3221225478u,
		STATUS_INVALID_HANDLE = 3221225480u,
		STATUS_ILLEGAL_INSTRUCTION = 3221225501u,
		STATUS_NONCONTINUABLE_EXCEPTION = 3221225509u,
		STATUS_INVALID_DISPOSITION = 3221225510u,
		STATUS_ARRAY_BOUNDS_EXCEEDED = 3221225612u,
		STATUS_FLOAT_DENORMAL_OPERAND = 3221225613u,
		STATUS_FLOAT_DIVIDE_BY_ZERO = 3221225614u,
		STATUS_FLOAT_INEXACT_RESULT = 3221225615u,
		STATUS_FLOAT_INVALID_OPERATION = 3221225616u,
		STATUS_FLOAT_OVERFLOW = 3221225617u,
		STATUS_FLOAT_STACK_CHECK = 3221225618u,
		STATUS_FLOAT_UNDERFLOW = 3221225619u,
		STATUS_INTEGER_DIVIDE_BY_ZERO = 3221225620u,
		STATUS_INTEGER_OVERFLOW = 3221225621u,
		STATUS_PRIVILEGED_INSTRUCTION = 3221225622u,
		STATUS_STACK_OVERFLOW = 3221225725u,
		STATUS_CONTROL_C_EXIT = 3221225786u,
		...
		__FILE___DEBUG_REGISTERS = __FILE___i386 | 16,
	...
	alias CHOOSECOLORW* PCHOOSECOLORW;
	...
	alias CHOOSECOLOR* PCHOOSECOLOR;
	...
	enum : DWORD
	{
		...
		bm_DCB_fDtrControl = 48,
		bp_DCB_fDtrControl = 4,
		bm_DCB_fDsrSensitivity = 64,
		bp_DCB_fDsrSensitivity = 6,
		bm_DCB_fTXContinueOnXoff = 128,
		bp_DCB_fTXContinueOnXoff = 7,
		bm_DCB_fOutX = 256,
		bp_DCB_fOutX = 8,
		bm_DCB_fInX = 512,
		bp_DCB_fInX = 9,
		bm_DCB_fErrorChar = 1024,
		bp_DCB_fErrorChar = 10,
		bm_DCB_fNull = 2048,
		bp_DCB_fNull = 11,
		bm_DCB_fRtsControl = 12288,
		bp_DCB_fRtsControl = 12,
		bm_DCB_fAbortOnError = 16384,
		bp_DCB_fAbortOnError = 14,
		bm_DCB_fDummy2 = 4294934528u,
		bp_DCB_fDummy2 = 15,
	}
	struct COMMCONFIG
	{
	...
	enum : DWORD
	{
		...
		bm_COMSTAT_fXoffSent = 16,
		bp_COMSTAT_fXoffSent = 4,
		bm_COMSTAT_fEof = 32,
		bp_COMSTAT_fEof = 5,
		bm_COMSTAT_fTxim = 64,
		bp_COMSTAT_fTxim = 6,
		bm_COMSTAT_fReserved = 4294967168u,
	...
	enum : DWORD
	{
		bm_DDEACK_bAppReturnCode = 255,
		bp_DDEACK_bAppReturnCode = 0,
		bm_DDEACK_reserved = 16128,
		bp_DDEACK_reserved = 8,
		bm_DDEACK_fBusy = 16384,
		bp_DDEACK_fBusy = 14,
		bm_DDEACK_fAck = 32768,
		bp_DDEACK_fAck = 15,
	}
	struct DDEADVISE
	{
	...
	enum : DWORD
	{
		bm_DDEADVISE_reserved = 16383,
		bp_DDEADVISE_reserved = 0,
		bm_DDEADVISE_fDeferUpd = 16384,
		bp_DDEADVISE_fDeferUpd = 14,
		bm_DDEADVISE_fAckReq = 32768,
	...
	enum : DWORD
	{
		bm_DDEDATA_unused = 4095,
		bp_DDEDATA_unused = 0,
		bm_DDEDATA_fResponse = 4096,
		bp_DDEDATA_fResponse = 12,
		bm_DDEDATA_fRelease = 8192,
		bp_DDEDATA_fRelease = 13,
		bm_DDEDATA_reserved = 16384,
		bp_DDEDATA_reserved = 14,
		bm_DDEDATA_fAckReq = 32768,
	...
	enum : DWORD
	{
		bm_DDELN_unused = 8191,
		bp_DDELN_unused = 0,
		bm_DDELN_fRelease = 8192,
		bp_DDELN_fRelease = 13,
		bm_DDELN_fDeferUpd = 16384,
		bp_DDELN_fDeferUpd = 14,
		bm_DDELN_fAckReq = 32768,
		bp_DDELN_fAckReq = 15,
	}
	...
	enum : DWORD
	{
		bm_DDEPOKE_unused = 8191,
		bp_DDEPOKE_unused = 0,
		bm_DDEPOKE_fRelease = 8192,
		bp_DDEPOKE_fRelease = 13,
		bm_DDEPOKE_fReserved = 49152,
	...
	enum : DWORD
	{
		bm_DDEUP_unused = 4095,
		bp_DDEUP_unused = 0,
		bm_DDEUP_fAck = 4096,
		bp_DDEUP_fAck = 12,
		bm_DDEUP_fRelease = 8192,
		bp_DDEUP_fRelease = 13,
		bm_DDEUP_fReserved = 16384,
		bp_DDEUP_fReserved = 14,
		bm_DDEUP_fAckReq = 32768,
		bp_DDEUP_fAckReq = 15,
	}
	...
	enum : DWORD
	{
		bm_LDT_ENTRY_BaseMid = 255,
		bp_LDT_ENTRY_BaseMid = 0,
		bm_LDT_ENTRY_Type = 7936,
		bp_LDT_ENTRY_Type = 8,
		bm_LDT_ENTRY_Dpl = 24576,
		bp_LDT_ENTRY_Dpl = 13,
		bm_LDT_ENTRY_Pres = 32768,
		bp_LDT_ENTRY_Pres = 15,
		bm_LDT_ENTRY_LimitHi = 983040,
		bp_LDT_ENTRY_LimitHi = 16,
		bm_LDT_ENTRY_Sys = 1048576,
		bp_LDT_ENTRY_Sys = 20,
		bm_LDT_ENTRY_Reserved_0 = 2097152,
		bp_LDT_ENTRY_Reserved_0 = 21,
		bm_LDT_ENTRY_Default_Big = 4194304,
		bp_LDT_ENTRY_Default_Big = 22,
		bm_LDT_ENTRY_Granularity = 8388608,
		bp_LDT_ENTRY_Granularity = 23,
		bm_LDT_ENTRY_BaseHi = 4278190080u,
	...
	alias MENUITEMINFOA* PMENUITEMINFOA;
	...
	alias MENUITEMINFOW* PMENUITEMINFOW;
	...
	alias MSG TMSG;
	alias MSG* PMSG;
	extern (Windows) alias void function(LPHELPINFO) MSGBOXCALLBACK;
	...
	const 
	{
		FILEOP_FLAGS FOF_MULTIDESTFILES = 1;
		FILEOP_FLAGS FOF_CONFIRMMOUSE = 2;
		FILEOP_FLAGS FOF_SILENT = 4;
		FILEOP_FLAGS FOF_RENAMEONCOLLISION = 8;
		FILEOP_FLAGS FOF_NOCONFIRMATION = 16;
		FILEOP_FLAGS FOF_WANTMAPPINGHANDLE = 32;
		FILEOP_FLAGS FOF_ALLOWUNDO = 64;
		FILEOP_FLAGS FOF_FILESONLY = 128;
		FILEOP_FLAGS FOF_SIMPLEPROGRESS = 256;
		FILEOP_FLAGS FOF_NOCONFIRMMKDIR = 512;
		FILEOP_FLAGS FOF_NOERRORUI = 1024;
		FILEOP_FLAGS FOF_NOCOPYSECURITYATTRIBS = 2048;
	}
	enum : UINT
	{
		FO_MOVE = 1,
	...
	enum : HRESULT
	{
		...
		E_NOINTERFACE = 2147500034u,
		E_POINTER = 2147500035u,
		E_HANDLE = 2147942406u,
		E_ABORT = 2147500036u,
		E_FAIL = 2147500037u,
		E_ACCESSDENIED = 2147942405u,
		E_PENDING = 2147483658u,
	}
}
...
extern (Windows) 
{
	alias LRESULT function(int code, int wParam, int lParam) MESSAGEPROC;
	alias BOOL function(LGRPID LanguageGroup, TCHAR* lpLanguageGroupString, TCHAR* lpLanguageGroupNameString, DWORD dwFlags, LONG_PTR lParam) LANGUAGEGROUP_ENUMPROC;
	struct COMBOBOXINFO
	{
		DWORD cbSize;
		RECT rcItem;
	...
	alias MENUINFO* PCMENUINFO;
	alias MENUINFO* LPCMENUINFO;
	alias MENUINFO* LPCCMENUINFO;
	struct MOUSEINPUT
	{
		LONG dx;
		LONG dy;
	...
	struct NOTIFYICONDATAA
	{
		...
		char[64] szInfoTitle = '\x00';
		DWORD dwInfoFlags;
		GUID guidItem;
		HICON hBalloonIcon;
	}
	alias NOTIFYICONDATAA* PNOTIFYICONDATAA;
	alias NOTIFYICONDATAA* LPNOTIFYICONDATAA;
	struct NOTIFYICONDATAW
	{
		...
		DWORD dwState;
		DWORD dwStateMask;
		WCHAR[256] szInfo = '\x00';
		union
		{
			UINT uTimeout;
			UINT uVersion;
		}
		WCHAR[64] szInfoTitle = '\x00';
		DWORD dwInfoFlags;
		GUID guidItem;
		HICON hBalloonIcon;
	}
	alias NOTIFYICONDATAW* PNOTIFYICONDATAW;
	alias NOTIFYICONDATAW* LPNOTIFYICONDATAW;
	version (Win32SansUnicode)
	{
	...
	alias SHELLEXECUTEINFOA* PSHELLEXECUTEINFOA;
	...
	alias SHELLEXECUTEINFOW* PSHELLEXECUTEINFOW;
	...
	alias TRACKMOUSEEVENT* PTRACKMOUSEEVENT;
